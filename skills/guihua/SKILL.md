---
name: guihua
description: 任务规划与进度跟踪。用于任务规划、项目拆解、多步骤执行和进度跟踪；会创建 task_plan.md、findings.md 和 progress.md 三个文件，适合“任务规划”“项目计划”“制定计划”“分解任务”“多步骤规划”“进度跟踪”“帮我规划”等中文触发场景。
...
```powershell
# Windows PowerShell
& (Get-Command python -ErrorAction SilentlyContinue).Source "$env:USERPROFILE\.codex\skills\guihua\scripts\session-catchup.py" (Get-Location)
```
